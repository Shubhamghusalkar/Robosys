...
function MasterKit() {
     const [isFilter, setIsFilter] = useState(false);
        ...
        { id: 1, name: "Shubham Ghusalkar", email: "shubham@gmail.com", mobile: "1234567890", address: "Dighi Pune, India", availability: "In Stock", checked: false },
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        ...
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        { id: 2, name: "Rutik Vyawahare", email: "rutik@gmail.com", mobile: "1234567890", address: "Alandi Pune, India", availability: "Out of Stock", checked: false },
        { id: 3, name: "Jambwant Awhale", email: "jam@gmail.com", mobile: "1234567890", address: "Vishrantwadi Pune, India", availability: "In Stock", checked: false },
      ]);
        // const [selectAll, setSelectAll] = useState(false);
        const selectAll = rows.length > 0 && rows.every(row => row.checked);
        ...
        const stockMatch =
          filter === "All" ||
          (filter === "In Stock" && row.availability.toLowerCase() === "in stock") ||
          (filter === "Out of Stock" && row.availability.toLowerCase() === "out of stock");
        ...
        <AdminBody
            content={
                <div className="page-wrapper w-full text-white text-xs">
                    <h4 className="text-lg font-normal mb-3">Master Kits</h4>
                                            ...
                                            <ul>
                                                {["All", "In Stock", "Out of Stock"].map((option) => (
                                                    <li
                                                        ...
                                                        className={`px-3 py-2 text-slate-300 font-medium cursor-pointer border-b border-slate-800 hover:text-white hover:underline text-nowrap ${filter === option ? "bg-slate-700" : ""
                                                            }`}
                                                    >
                                                        {option}
                                                    </li>
                            ...
                            <table className="w-full">
                                <thead className="bg-slate-800">
                                    <tr>
                                        ...
                                        <th className="p-2.5 text-base font-normal text-slate-200">Sr. No.</th>
                                        <th className="p-2.5 text-start text-base font-normal text-slate-200">Kit Name</th>
                                        <th className="p-2.5 text-base font-normal text-slate-200">STD</th>
                                        <th className="p-2.5 text-base font-normal text-slate-200">Price</th>
                                        <th className="p-2.5 text-base font-normal text-slate-200">Availability</th>
                                    ...
                                    {filteredData.length > 0 ? (
                                        filteredData.map((row, index) => (
                                            <tr className="border-b border-b-slate-800 hover:bg-slate-900/50">
                                                <td className="p-1.5 text-sm text-center font-normal text-slate-400 ps-2"><input type="checkbox" checked={row.checked}
                                                    onChange={() => handleRowCheck(row.id)} /></td>
                                                <td className="p-1.5 text-sm text-center font-normal text-slate-400">{index + 1}</td>
                                                <td className="p-1.5 text-sm font-normal text-slate-400">{row.name}</td>
                                                <td className="p-1.5 text-sm text-center font-normal text-slate-400">{row.std}</td>
                                                <td className="p-1.5 text-sm text-center font-normal text-slate-400">{row.price}</td>
                                                <td className={`p-1.5 text-sm text-center font-normal ${row.availability.toLowerCase() === "out of stock"
                                                    ? "text-red-600"
                                                    : "text-green-700"
                                                    }`}>{row.availability}</td>
                                                <td className="p-1.5 text-sm text-center font-normal text-slate-400">
                                                    <div className="flex gap-1 items-center justify-center">
                                                        <Link to={'/kits-view'} type="button" className="bg-gray-700 hover:bg-gray-800 p-2 rounded text-white " title="View"><FiEye /></Link>
                                                        <Link to={'/add-kits'} type="button" className="bg-green-700 hover:bg-green-800 p-2 rounded text-white " title="Edit"><GoPencil /></Link>
