                                ...
                                <div className=' grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                                    {
                                        product.map((product, index) => (
                                            <div className='product-card group bg-slate-800 rounded-md border border-slate-700 hover:-translate-y-2 transition-all duration-300 ' data-aos="fade-up" data-aos-offset="50"  data-aos-duration="600">
